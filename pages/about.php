        ...
        <div style="max-width:900px; margin:0 auto;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:2rem; align-items:center;" class="grid-2">
                <div>
                    ...
                    <p>Holy Trinity Parish was established as a beacon of Catholic faith in the heart of Kabwe. From its humble beginnings, the parish has grown into a vibrant community of believers united in their devotion to the Holy Trinity — Father, Son, and Holy Spirit.</p>
